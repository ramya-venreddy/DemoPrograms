...
/** Strongly typed access to the database table "animal".
 *
...
public class AnimalTable
{
    ...
    public static final String speciesColumnName = "species";
    public static final String quantityColumnName = "quantity";
    public static final String buildingIDColumnName = "buildingID";

    private static String[] allColumns =
    {
        idColumnName , speciesColumnName , quantityColumnName , buildingIDColumnName , 
    };
     ...
     *  you wanted to.
     *  
     *  To use this in your unit testing, create an instance of MockAnimalTable and pass
     *  it in here.  Then set your mock return values, call the method you are testing and examine
     *  the mock values that are now set!
     */
    public static void setInstance( AnimalTable.Implementation instance  )
    {
        imp = instance ;
    }
    ...
    static class Implementation extends TableFacade
    {
        ...
        Implementation()
        {
            super( SoupFacade.getInstance() , tableName );
        }
    ...
    public static class Row
    {
        ...
        private boolean buildingIDNull = true ;
        ...
        private Row( String[] data )
        {
            if ( data != null )
            {
                ...
                this.id = idNull ? 0 : Str.toInt( data[0] );
                this.species = data[1];
                this.quantityNull = ( data[2] == null );
                this.quantity = quantityNull ? 0 : Str.toInt( data[2] );
                this.buildingIDNull = ( data[3] == null );
                this.buildingID = buildingIDNull ? 0 : Str.toInt( data[3] );
        ...
        public void setBuildingID( int buildingID )
        {
            ...
            buildingIDNull = false ;
        }

        public void setBuildingID( Integer buildingID )
        {
            buildingIDNull = ( buildingID == null );
            if ( buildingIDNull )
            {
                this.buildingID = 0 ;
            }
            ...
            {
                this.buildingID = buildingID.intValue() ;
            }
        }

        public boolean isBuildingIDNull()
        {
            return buildingIDNull ;
        }

        public void setBuildingIDNull( boolean buildingIDNull )
        {
            this.buildingIDNull = buildingIDNull ;
            if ( buildingIDNull )
            {
                buildingID = 0 ;
            }
        ...
        private Map buildDataMap()
        {
            ...
            data.put( speciesColumnName , this.species );
            data.put( quantityColumnName , this.quantityNull ? null : String.valueOf( this.quantity ) );
            data.put( buildingIDColumnName , this.buildingIDNull ? null : String.valueOf( this.buildingID ) );
            return data ;
        }
